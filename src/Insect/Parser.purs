...
normalUnitDict = Dictionary
  ...
  , Q.hertz ==> ["hertz", "Hz"]
  , Q.rpm ==> ["RPM", "rpm"]
  , Q.newton ==> ["newtons", "newton", "N"]
  , Q.joule ==> ["joules", "joule", "J"]
  , Q.pascal ==> ["pascals", "pascal", "Pa"]
  , Q.volt ==> ["volts", "volt", "V"]
  , Q.farad ==> ["farads", "farad", "F"]
  , Q.ohm ==> ["ohms", "ohm", "Ω"]
  , Q.sievert ==> ["sieverts", "sievert", "Sv"]
  , Q.weber ==> ["webers", "weber", "Wb"]
  , Q.tesla ==> ["teslas", "tesla", "T"]
  , Q.henry ==> ["henrys", "henries", "henry", "H"]
  , Q.coulomb ==> ["coulombs", "coulomb", "C"]
  , Q.siemens ==> ["siemens", "S"]
  , Q.lumen ==> ["lumens", "lumen", "lm"]
  , Q.lux ==> ["lux", "lx"]
  , Q.becquerel ==> ["becquerels", "becquerel", "Bq"]
  , Q.gray ==> ["grays", "gray", "Gy"]
  , Q.katal ==> ["katals", "katal", "kat"]
  , Q.hectare ==> ["hectares", "hectare", "ha"]
  , Q.tonne ==> ["tonnes", "tonne", "tons", "ton"]
  , Q.electronvolt ==> ["electronvolts", "electronvolt", "eV"]
